           ...
           <div class="navbar-nav flex-row order-md-last">
               ...
               <div class="nav-item dropdown">
                   <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                       ...
                       @if (Auth::user()->gambar_profile)
                           <span class="avatar avatar-sm"
                               style="background-image: url({{ asset('storage/' . Auth::user()->gambar_profile) }})"></span>
                       @else
                           <span
                               class="avatar avatar-sm">{{ strtoupper(substr(Auth::user()->name ?? Auth::user()->username, 0, 2)) }}</span>
                       @endif
           ...
           <div class="navbar navbar-light">
               <div class="container-xl">
                   <ul class="navbar-nav">
                       ...
                       <li
                           class="nav-item {{ Route::is('bukus.index', 'bukus.create', 'bukus.edit', 'bukus.show') ? 'active' : '' }}">
