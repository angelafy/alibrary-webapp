<aside class="scroll-container hidden lg:block w-1/6 border-r fixed left-0 top-0 h-screen py-6 overflow-y-auto z-10">
    ...
    <div class="mt-6 flex flex-col gap-y-1 text-gray-500 fill-gray-500 text-sm">
        ...
        <a href="{{ route('pinjam.index') }}"
            class="flex items-center space-x-2 p-2 hover:bg-gray-50 hover:text-primary-500 pl-4 lg:pl-6 {{ Route::is('pinjam.index') ? 'border-l-4 border-l-primary-600 text-primary-600' : '' }}">
        ...
        <a href="{{ route('pinjam.keranjang') }}"
        class="flex items-center space-x-2 p-2 hover:bg-gray-50 hover:text-primary-500 pl-4 lg:pl-6 {{ Route::is('pinjam.keranjang') ? 'border-l-4 border-l-primary-600 text-primary-600' : '' }}">
        ...
        @if ($totalDetailKeranjang > 0)
            <span class="flex items-center justify-center px-2 py-1 text-xs font-medium leading-none text-white bg-orange-600 rounded-full">
                {{ $totalDetailKeranjang }}
            </span>
        @endif
    </a>
