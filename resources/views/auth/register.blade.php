    ...
    <div class="flex min-h-screen bg-white lg:bg-gray-50 py-0 lg:py-16 px-0 lg:px-56">
        <div class="my-0 lg:my-auto w-full rounded-lg bg-white shadow-none lg:shadow-sm">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-1 gap-x-4 lg:gap-x-8 items-center">
                ...
                {{-- form gawe regist --}}
                <form class="needs-validation space-y-6 px-4 lg:px-8 pt-4 pb-8" method="POST" action="{{ route('register') }}">
                    @csrf
                    ...
                    <div class="space-y-2 lg:space-y-4">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-4">
                            ...
                            <div>
                                ...
                                <input id="telepon" type="text" class="number-only-input w-full bg-gray-50 mt-1 block p-2 lg:p-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded focus:outline-none focus:ring-primary-500 focus:border-primary-500 text-xs lg:text-sm @error('telepon') is-invalid @enderror"
                        ...
                        <div>
                            ...
                            <input id="email" type="email" class="w-full bg-gray-50 mt-1 block p-2 lg:p-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded focus:outline-none focus:ring-primary-500 focus:border-primary-500 text-xs lg:text-sm @error('email') is-invalid @enderror"
                        ...
                        <div>
                            ...
                            <input id="username" type="text" class="latin-only-input w-full bg-gray-50 mt-1 block p-2 lg:p-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded focus:outline-none focus:ring-primary-500 focus:border-primary-500 text-xs lg:text-sm @error('username') is-invalid @enderror"
                        ...
                        <div>
                            ...
                            <input id="password" type="password" class="w-full bg-gray-50 mt-1 block p-2 lg:p-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded focus:outline-none focus:ring-primary-500 focus:border-primary-500 text-xs lg:text-sm @error('password') is-invalid @enderror"
                        ...
                        <div>
                            ...
                            <input id="password-confirm" type="password" class="w-full bg-gray-50 mt-1 block p-2 lg:p-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded focus:outline-none focus:ring-primary-500 focus:border-primary-500 text-xs lg:text-sm"
                                   name="password_confirmation" required>
                        </div>
                
                        <div class="flex items-center justify-end mt-4">
                            <button type="submit" class="px-6 py-2 bg-primary-500 text-white rounded-md hover:bg-primary-600">
                                Daftar
                            </button>
                        </div>
                    </div>
