                                                    <x-client-app>
                                                        ...
                                                        <main class="w-full lg:w-4/6 mx-auto p-4 mb-16 lg:mb-0">
                                                            <div
                                                                class="fixed left-0 lg:left-5 bottom-0 lg:bottom-1 z-50">
                                                            </div>
                                                            <div class="min-h-screen">
                                                                <section>
                                                                    ...
                                                                    <div class="relative">
                                                                        <div
                                                                            class="fixed w-full lg:w-4/6 z-10 mx-auto justify-center bottom-0 left-0 right-0">
                                                                            <form class="needs-validation"
                                                                                id="checkout-form"
                                                                                action="https://perpustakaan.jakarta.go.id/transaction/store"
                                                                                method="POST">
                                                                                <input type="hidden" name="_token"
                                                                                    value="hXMOprJNZnt2XEeoLcjwRMbiXcjWRcOW6LoWeVGp">
                                                                                <input type="hidden" name="cart_id[]"
                                                                                    value="9dbccfe9-14da-4a3f-8426-e235f25a666c">
                                                                                <input type="hidden"
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div x-data="{ checkoutModal: false }"
                                                                                        x-cloak>
                                                                                        <div x-data="{ isKeranjangEmpty: {{ $totalDetailKeranjang == 0 ? 'true' : 'false' }} }"
                                                                                            x-cloak>
                                                                                                ...
                                                                                                <div @click.outside="checkoutModal = false"
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <div
                                                                                                                class="mt-3 w-full sm:mt-0.5 sm:ml-4 sm:text-left">
                                                                                                                ...
                                                                                                                <p
                                                                                                                    class="text-gray-600 text-xs text-center lg:text-start">
                                                                                                                    Pilih
                                                                                                                    lokasi
                                                                                                                    pengambilan
                                                                                                                    dan
                                                                        ...
                                                                        @foreach ($keranjang->detailKeranjang as $detail)
                                                                            <div class="my-4 lg:my-6">
                                                                                <div
                                                                                    ...
                                                                                    <div
                                                                                        class="rounded-lg border p-3 lg:p-4 bg-gray-50">

                                                                                        <div
                                                                                            class="grid grid-cols-12 gap-4 lg:gap-5">
                                                                                    ...
                                                                                    @else --}}
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div>
                                                                                                    <h1
                                                                                                        class="font-bold text-sm lg:text-xl line-clamp-2">
                                                                                                        {{ $detail->buku->title }}
                                                                                                    </h1>
                                                                                                    <h3
                                                                                                        class="text-gray-700 text-xs lg:text-sm line-clamp-1 mt-1 lg:mt-0">
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="text-xs mt-2 lg:mt-3 text-gray-600">
                                                                                                        Sinopsis:
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div id="bookItem"
                                                                                                        ...
                                                                                                        <div
                                                                                                            ...
                                                                                                            <!-- Tombol Hapus -->
                                                                                                            <button
                                                                                                                onclick="deleteCartItem('{{ $detail->id }}')"
