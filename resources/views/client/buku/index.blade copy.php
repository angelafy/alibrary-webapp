                    ...
                    <div class="my-4 lg:my-4">
                        <div class="flex justify-between gap-2 lg:gap-4">
                            ...
                            <div x-data="{ filterLibraryLocationModal: false, selectedSort: 'latest' }">
                                ...
                                <div @click="filterLibraryLocationModal = true" class="flex items-center cursor-pointer gap-2 text-primary-500 rounded-lg text-sm p-2 lg:px-6 lg:py-2 border border-primary-500 hover:bg-gray-50">
                                ...
                                <!-- Modal untuk Filter -->
                                <div class="fixed z-50 inset-0 overflow-y-auto" x-show="filterLibraryLocationModal" x-cloak>
                                    <div class="min-h-screen flex items-center justify-center p-4 text-center sm:block sm:p-0">
                                        <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" aria-hidden="true"></div>
                                        <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">​</span>
                                        <div @click.outside="filterLibraryLocationModal = false" class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:align-middle w-full lg:max-w-4xl">
                                            <div class="bg-white p-4">
                                                <div class="mb-1">
                                                    <div class="flex items-center justify-end font-medium text-sm lg:text-base">
                                                        <div @click="filterLibraryLocationModal = false">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="cursor-pointer h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                ...
                                                <div class="my-4">
                                                    ...
                                                    <select id="sort" name="sort" x-model="selectedSort" class="form-select p-2 w-full border-2 border-gray-100 bg-gray-100 pl-6 rounded-lg text-xs lg:text-sm">
                                                ...
                                                <!-- Filter Genre -->
                                                <div class="my-4">
                                                    <div class="font-medium text-sm lg:text-base">Pilih Genre</div>
                                                    <select id="genre" name="genre" x-model="selectedGenre" class="form-select p-2 w-full border-2 border-gray-100 bg-gray-100 pl-6 rounded-lg text-xs lg:text-sm">
                                            ...
                                            <div class="flex flex-nowrap items-center justify-center gap-2 bg-gray-50 px-4 py-3">
                                                <button type="button" @click="window.location.href = '/buku?sort=' + selectedSort + '&genre=' + selectedGenre" class="w-full flex justify-center py-2 px-3 border border-transparent text-sm font-medium rounded-md text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                                                    Terapkan
                                                </button>
                                            </div>
                                        </div>
